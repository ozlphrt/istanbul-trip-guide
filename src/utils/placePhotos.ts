...
export function getPlacePhotoUrl(eventId: string, title: string = ''): string {
  ...
  // 8. Bosphorus Ferry & Kadıköy / Üsküdar Strait Cruise
  ...
  // 9. Karaköy Güllüoğlu / Baklava / Hacı Bekir / Sweets
  ...
  // 10. Turkish Tea & Simit / Coffee (Kurukahveci Mehmet Efendi)
  ...
  // 11. Şehzade Cağ Kebap / Hamdi / Çiya / Lokanta
  ...
  // 12. İstiklal Avenue / Vintage Nostalgic Tramway / Pera
  ...
  // 13. Ortaköy Mosque & Bosphorus Bridge
  ...
  // 17. Fener & Balat Historic District
