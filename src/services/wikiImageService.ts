...
const SEARCH_QUERY_OVERRIDES: Record<string, string> = {
  ...
  'ist26-0923-3': 'Hagia Sophia Istanbul interior dome mosaic',
  'ist26-0923-4': 'Hippodrome of Constantinople Istanbul Obelisk',
  'ist26-0923-5': 'Basilica Cistern Istanbul Medusa column',
  'ist26-0923-6': 'Grand Bazaar Istanbul Kapalicarsi interior',
  'ist26-0923-7': 'Eminonu Golden Horn view kebab Istanbul',
  'ist26-0923-8': 'Spice Bazaar Istanbul Misir Carsisi',
  'ist26-0923-9': 'Istanbul ferry Sehir Hatlari Bosphorus',
  'ist26-0923-10': 'Kuzguncuk Istanbul houses',
  'ist26-0923-11': 'Kuzguncuk Bosphorus fish meyhane',
  'ist26-0923-12': 'Istanbul Bosphorus ferry night skyline',
  ...
  'ist26-0926-3': 'Turkish ocakbasi kebab restaurant Sirkeci',
  'ist26-0926-4': 'Turkish coffee cezve Istanbul cafe',
  'ist26-0926-5': 'Sirkeci historic train station Istanbul',
  'ist26-0926-6': 'Istanbul Airport Havaist transfer',
  'ist26-0926-7': 'Istanbul Airport departure hall gate'
};
