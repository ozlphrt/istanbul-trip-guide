  ...
  return (
    <div className="bg-[#1f2431] rounded-2xl sm:rounded-3xl border border-slate-700/70 shadow-inner p-2 sm:p-3.5 mb-8 select-none">
      ...
      >
        ...
        <div className="w-12 sm:w-14 shrink-0 relative border-r border-slate-700/70 select-none">
          {hours.map((hour) => {
            ...
            return (
              <React.Fragment key={`axis-${hour}`}>
                {/* Major Hour Label (Large & Highly Legible) */}
                <div
                  style={{ top: `${topOffsetPx}px` }}
                  className="absolute right-1.5 -translate-y-1/2 text-xs sm:text-sm font-mono text-slate-200 font-extrabold tracking-tight"
                >
                  {displayHour}
                </div>
                ...
                {hour < TIMELINE_END_HOUR && (
                  <>
                    <div
                      ...
                      className="absolute right-0 w-1 border-t border-slate-600/40"
                    />
                    <div
                      style={{ top: `${top30Px}px` }}
                      className="absolute right-0 w-1.5 border-t border-slate-500/60"
                    />
                    <div
        ...
        <div className="flex-1 relative ml-1.5 sm:ml-2.5">
