...
export const Toolbar: React.FC<ToolbarProps> = ({
  ...
  return (
    <div className="bg-zinc-900 border border-zinc-800 rounded-2xl p-4 mb-5 space-y-3.5 shadow-subtle">
      ...
      <div className="flex flex-wrap items-center justify-between gap-3">
        ...
        <div className="flex items-center gap-2.5">
          ...
          <div>
            ...
            <div className="w-32 sm:w-44 bg-zinc-800 h-2 rounded-full overflow-hidden mt-1.5">
              <div
      ...
      <div className="pt-3 border-t border-zinc-800 flex flex-wrap items-center justify-between gap-2.5 text-sm">
        ...
        <div className="flex items-center gap-1.5">
          ...
          {runningLateShift > 0 && (
            <button
              ...
              className="p-1.5 rounded-xl text-zinc-400 hover:text-zinc-100 hover:bg-zinc-800 transition ml-1"
